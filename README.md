...
- [ChrisBoettner/sbx-pi-kit](https://github.com/ChrisBoettner/sbx-pi-kit) - A v2 spec Docker Sandbox kit for the Pi coding agent, updated to the latest sbx spec format. _Maturity: 0⭐, no releases. Security: n/a. Auto-added 2026-08-21, unreviewed._
- [WolfHero/codex-deepseek-sbx-kit](https://github.com/WolfHero/codex-deepseek-sbx-kit) - Sandbox kit based on `docker/sandbox-templates:codex` that keeps the Codex CLI intact while switching the model provider to DeepSeek, with sbx's built-in key injection mechanism for secure API key handling. _Maturity: 0⭐, no releases. Security: proxy. Auto-added 2026-08-21, unreviewed._
- [ZYCGary/sbx-kits](https://github.com/ZYCGary/sbx-kits) - Declarative sbx kits for Docker Sandbox agents. _Maturity: 0⭐, no releases. Security: n/a. Auto-added 2026-08-21, unreviewed._
- [bmillerz/sbx-workbench](https://github.com/bmillerz/sbx-workbench) - Docker Sandbox templates and kits including Laravel and WordPress workbench images plus shared mixin kits for web development workflows. _Maturity: 1⭐, no releases. Security: n/a. Auto-added 2026-08-21, unreviewed._
- [krisfoster/claude-code-bedrock-sbx](https://github.com/krisfoster/claude-code-bedrock-sbx) - Two working approaches to run Claude Code against AWS Bedrock from inside a Docker Sandbox (sbx): via the claude-bedrock kit or a host-side LiteLLM gateway. _Maturity: 1⭐, no releases. Security: proxy. Auto-added 2026-08-21, unreviewed._
- [qunm00/sbx-opencode-kit](https://github.com/qunm00/sbx-opencode-kit) - Docker Sandbox kit for running the opencode coding agent in an isolated sbx environment. _Maturity: 0⭐, no releases. Security: n/a. Auto-added 2026-08-21, unreviewed._
- [raisiqueira/docker-sbx-kits](https://github.com/raisiqueira/docker-sbx-kits) - Personal Docker SBX Kits collection including Grok AI agent support. _Maturity: 0⭐, no releases. Security: n/a. Auto-added 2026-08-21, unreviewed._
- [rverchere/sbx-kit-claude-project-host](https://github.com/rverchere/sbx-kit-claude-project-host) - Docker sbx mixin kit that persists Claude Code's memory and transcripts to the host filesystem, surviving sandbox deletion, with hooks and personal settings replication. _Maturity: 2⭐, no releases. Security: n/a. Auto-added 2026-08-21, unreviewed._
- [shelajev/dsh-sbx-kit](https://github.com/shelajev/dsh-sbx-kit) - Docker Sandboxes kit for DeepSeek Harness (dsh): Web UI on a published port, headless `--task` runs, and DeepSeek API key injected by the sandbox proxy. _Maturity: 0⭐, no releases. Security: proxy. Auto-added 2026-08-21, unreviewed._
- [shelajev/muse-code-sbx-kit](https://github.com/shelajev/muse-code-sbx-kit) - Docker Sandboxes kit for running Meta's Muse Code CLI in an isolated sandbox. _Maturity: 0⭐, no releases. Security: n/a. Auto-added 2026-08-21, unreviewed._
- [shelajev/neon-sbx-kit](https://github.com/shelajev/neon-sbx-kit) - Docker Sandboxes kit for provisioning and connecting Neon Serverless Postgres databases with proxy-managed authentication inside a sandbox. _Maturity: 0⭐, no releases. Security: proxy. Auto-added 2026-08-21, unreviewed._
- [shelajev/yt-transcript-sbx-kit](https://github.com/shelajev/yt-transcript-sbx-kit) - Docker Sandboxes mixin kit that installs yt-dlp and ffmpeg and converts YouTube video captions into clean plain text for use by sandboxed agents. _Maturity: 0⭐, 1 fork. Security: n/a. Auto-added 2026-08-21, unreviewed._
